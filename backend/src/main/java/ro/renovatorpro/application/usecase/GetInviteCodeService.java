...
public class GetInviteCodeService implements GetInviteCodeUseCase {
    ...
    public String execute(String currentUserId, String projectId) {
        ...
        return projectRepository.findInviteCode(projectId)
                .orElseGet(() -> generateAndStore(projectId));
    }

    private String generateAndStore(String projectId) {
