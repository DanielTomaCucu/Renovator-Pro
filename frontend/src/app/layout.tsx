  ...
  return (
    ...
    >
      <body className="min-h-full">
        {/* Sidebar-ul NU folosește useStore() — rămâne în afara StoreProvider ca să fie vizibil și
            navigabil cât timp datele se încarcă (backend-ul poate avea cold-start de zeci de secunde). */}
