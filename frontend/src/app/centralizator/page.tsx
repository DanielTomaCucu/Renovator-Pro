...
const MATERIAL_BADGE_STYLES: Record<MaterialType, string> = {
  ...
  [MaterialType.Amorsa]: "bg-orange-50 text-orange-700",
  [MaterialType.AdezivPlacari]: "bg-sky-50 text-sky-700",
  [MaterialType.ChitRosturi]: "bg-emerald-50 text-emerald-700",
  [MaterialType.FolieParchet]: "bg-purple-50 text-purple-700",
